...
<script type="text/javascript">
    $(document).ready(()=>{
    $("#nombreRes").val('<?php echo $row['idResidente']; ?>');
    $("#tipoDoc").val('<?php echo $row['idTipoDocumento']; ?>');
    ...
    <form class="form" action="" method="post"  enctype="multipart/form-data">
    	<div class="container">
    		<div class="form-group">
    			...
    			<input type="date" id="periodo" name="periodo" onchange="myFunction()" value="<?php echo $row['Periodo']; ?>" class="form-control" required>
    		</div>
    		<div class="form-group">
