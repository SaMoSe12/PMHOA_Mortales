...
<?php
   ...
   $limit = 10;
    ...
    $sql = "SELECT SQL_CALC_FOUND_ROWS idAdministrativo, nombreAdmin, apellidoPAdmin, correoAdmin, userAdmin, passwordAdmin, idFraccionamiento FROM CatalogoAdministrativos LIMIT $offset, $limit";
 ...
 <body>
    ...
    <table id="data_table" class="table table-striped">
       ...
       <?php
         ...
         {
          $id = $row["idAdministrativo"];
          $name = htmlentities($row["nombreAdmin"]." ".$row["apellidoPAdmin"]);
          $user = htmlentities($row["userAdmin"]);
          $mail = htmlentities($row["correoAdmin"]);
       ...
       ?>
            ...
            <td><a href="/admin/editar-administrador?EDITAR_ID=<?php echo $id; ?>"><i class="fas fa-user-edit"></i></a></td>
            </tr>
       <?php
         }
       ?>
    ...
    <button type="button" class="btn btn-info"><a href="/admin/agregar-administrador">Añadir administrador</a></button> 
    </div> 
    </div>
    <br/>
         <?php 
