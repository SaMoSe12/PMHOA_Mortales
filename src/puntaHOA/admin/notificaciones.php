        ...
        <table id="data_table" class="table table-striped">
           ...
           <th>Acción</th>  
            ...
            ?>
                ...
                <td><?php echo $desc; ?></td>
                <td><a href="editar-notificacion?EDITAR_ID=<?php echo $id; ?>"><i class="fas fa-edit"></i></a></td>
                </tr>
            <?php
             }
            ?>
         ...
         <div class="float-right">
            <button type="button" class="btn btn-info"><a href="/admin/crear-notificacion">Crear Notificacion</a></button> 
            <button type="button" class="btn btn-info"><a href="/admin/control-notificaciones">Asignar Notificacion</a></button>
            <button type="button" class="btn btn-info"><a href="/admin/anuncios-fraccionamiento?pag=1">Editar Parametros de Notificaciones</a></button>
         </div>
    </div>
    <br/>
         <?php 
