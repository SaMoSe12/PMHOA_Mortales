      ...
      if($count == 1) {
		...
		$error = "No se actualizo la información debido a que esta propiedad pertenece al usuario: ".$nomRes. " " .$apeRes;
      	 ...
      	 if (mysqli_query($conn, $actualizar)) {
            ...
            window.location.href='homeAdmin.php?pag=1';
            </script>";
		 } else {
        ...
        <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-light bg-white border-bottom box-shadow mb-3">
            <div class="container">
                ...
                <div class="d-flex flex-row-reverse bd-highlight">
                   <div class="p-2 bd-highlight"><a href="logout.php" style="color: black;">Cerrar Sesión</a></div> 
    ...
    <div class="container"> 
    	...
    	<form class="form" action="" method="post">
            ...
            <center>
                ...
                <div class="col">
                    <button type="button" class="btn btn-danger"><a href="homeAdmin.php?pag=1">Regresar</a></button>
                </div>
                </div>
            </center>
    	</form>   
